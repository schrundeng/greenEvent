...
<section class="bg-gray-50 min-h-screen py-8 md:py-12">
    <div class="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div class="bg-white p-6 sm:p-8 rounded-xl shadow-sm mb-8">
            <h2 class="text-xl sm:text-2xl font-semibold text-green-700 mb-4 flex items-center gap-2">
                <i class="fa-solid fa-seedling text-green-600"></i> Misi Kami
            </h2>
        ...
        <div class="bg-white p-6 sm:p-8 rounded-xl shadow-sm mb-8">
            <h2 class="text-xl sm:text-2xl font-semibold text-green-700 mb-4 flex items-center gap-2">
                <i class="fa-solid fa-lightbulb text-yellow-500"></i> Apa yang Kami Tawarkan
            </h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 text-gray-700">
                <div>
                    <h3 class="font-semibold text-lg mb-1 flex items-center gap-2">
                        <i class="fa-solid fa-ticket text-green-600"></i> Temukan Event
                    </h3>
                ...
                <div>
                    <h3 class="font-semibold text-lg mb-1 flex items-center gap-2">
                        <i class="fa-solid fa-calendar-days text-green-600"></i> Kelola Event
                    </h3>
        ...
        <div class="bg-green-700 text-white p-6 sm:p-8 rounded-xl shadow-md text-center">
            <h2 class="text-xl sm:text-2xl font-bold mb-2 flex items-center justify-center gap-2">
                <i class="fa-solid fa-leaf"></i> Bersama, Kita Hijaukan Dunia
            </h2>
