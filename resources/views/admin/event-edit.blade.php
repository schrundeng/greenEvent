...
<div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
    ...
    <form action="{{ route('admin.event-update', $id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label for="latitude" class="block font-semibold text-gray-700 mb-2">Latitude</label>
                <input type="text" id="latitude" name="latitude" value="{{ old('latitude', $event->latitude) }}"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none">
            </div>
            <div>
                <label for="longitude" class="block font-semibold text-gray-700 mb-2">Longitude</label>
