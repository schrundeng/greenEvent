       ...
       <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 text-sm text-gray-700">
           ...
           <div>
               ...
               <div class="flex items-center gap-5 text-xl">
                   <a href="github.com/schrundeng" class="hover:text-gray-800 text-gray-600 transition" title="GitHub">
                       <i class="fa-brands fa-github"></i>
                   </a>
                   <a href="https://github.com/sternnaufal" class="hover:text-blue-500 text-gray-600 transition" title="Twitter">
                       <i class="fa-brands fa-x-twitter"></i>
                   </a>
                   <a href="https://github.com/ghawra" class="hover:text-pink-600 text-gray-600 transition" title="Instagram">
