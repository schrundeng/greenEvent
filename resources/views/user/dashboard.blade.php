                    ...
                    @if (!in_array($event->status, ['ended', 'draft']))
                        <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-transform transform hover:-translate-y-1 p-4 flex flex-col">
                            ...
                            <img 
                                ...
                                alt="{{ $event->title }}" 
                                class="rounded-lg mb-3 w-full h-48 object-cover lazy">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="mt-3">
                                    ...
                                    <span class="text-xs font-medium px-3 py-1 rounded-full flex items-center gap-1 w-fit {{ $statusColors[$status] ?? 'bg-gray-100 text-gray-500' }}">
