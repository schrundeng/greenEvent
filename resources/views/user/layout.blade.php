...
<body class="bg-gray-50 text-gray-800 min-h-screen flex flex-col">
  ...
  <nav class="sticky top-0 w-full bg-[#00C853] text-white shadow-md z-9999">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
      ...
      <div class="hidden md:flex items-center space-x-4 lg:space-x-6">
        ...
        <a href="{{ route('user.event-history') }}" class="font-medium hover:text-gray-100 transition flex items-center gap-1"><i class="fa fa-calendar" aria-hidden="true"></i> My Events</a>
        <a href="{{ route('user.profile') }}" class="font-medium hover:text-gray-100 transition flex items-center gap-1"><i class="fa-solid fa-user-tie"></i> Hi, {{ auth()->user()->username ?? '' }}!</a>
    ...
    <!-- Mobile menu -->
    <div id="menu-mobile" class="hidden md:hidden bg-[#00C853] px-4 sm:px-6 pb-4 space-y-2">
  ...
  <footer class="bg-gradient-to-b from-green-50 to-green-100 border-t border-green-200 mt-16 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-sm text-gray-700">
        <!-- Tentang -->
        <div>
    ...
    <div class="mt-10 border-t border-green-200 pt-6 text-center text-xs text-gray-500">
